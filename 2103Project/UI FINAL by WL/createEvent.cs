    ...
    public partial class createEventForm : Form
    {
        ...
        private void createButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                EventEntity events = new EventEntity(neweventId, eventNameTextBox.Text, startTimePicker.Value, endTimePicker.Value, newscheduleId, int.Parse(sizeTextBox.Text), participantList);
